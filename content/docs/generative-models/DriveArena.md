...
*관련 논문: [LDM](/posts/papers/high-resolution-image-synthesis-with-latent-diffusion-models/), [GAIA-1](/posts/papers/GAIA-1/), [DriveDreamer](/posts/papers/DriveDreamer/), [MagicDrive](/posts/papers/magicdrive-street-view-generation-3d-geometry-control/), [CARLA](/posts/papers/CARLA-An-Open-Urban-Driving-Simulator/), [nuScenes](/posts/papers/nuscenes-multimodal-dataset-autonomous-driving/)*
