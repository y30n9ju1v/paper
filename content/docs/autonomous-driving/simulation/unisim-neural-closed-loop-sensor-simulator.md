...
*관련 논문: [NeRF](/posts/papers/nerf-representing-scenes-as-neural-radiance-fields-for-view-synthesis/), [EmerNeRF](/posts/papers/EmerNeRF/), [NeuRAD](/posts/papers/neurad-neural-rendering-for-autonomous-driving/), [LiDARsim](/posts/papers/lidarsim-realistic-lidar-simulation-by-leveraging-the-real-world/), [HUGSIM](/posts/papers/hugsim-real-time-photorealistic-closed-loop-simulator/), [nuScenes](/posts/papers/nuscenes-multimodal-dataset-autonomous-driving/)*
