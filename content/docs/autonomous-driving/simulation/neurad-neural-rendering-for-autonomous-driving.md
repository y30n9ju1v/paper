...
*관련 논문: [NeRF](/posts/papers/nerf-representing-scenes-as-neural-radiance-fields-for-view-synthesis/), [Instant-NGP](/posts/papers/instant-ngp-multiresolution-hash-encoding/), [EmerNeRF](/posts/papers/EmerNeRF/), [UniSim](/posts/papers/unisim-neural-closed-loop-sensor-simulator/), [LiDARsim](/posts/papers/lidarsim-realistic-lidar-simulation-by-leveraging-the-real-world/), [nuScenes](/posts/papers/nuscenes-multimodal-dataset-autonomous-driving/)*
